...
CONSOLIDACIÓN COMPLETADA: Tienes toda la evidencia reverse engineering documentada con offset exacto, valores verificados, y parcheo productivo listo para implementar en Lima driver.